...
| ------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------ |
| Register                        | Authentication is handled by allauth, allowing users to register accounts. I have added a custom form so that users are required to give first name and last name when registering an account.                                                           | ![screenshot](documentation/features/register.png)           |
| Login                           | Authentication is handled by allauth, allowing users to log in to their existing accounts.                                                                                                                                                               | ![screenshot](documentation/features/login.png)              |
| Logout                          | Authentication is handled by allauth, allowing users to log out of their accounts.                                                                                                                                                                       | ![screenshot](documentation/features/logout.png)             |
| Hero Section                    | The homepage displays a large hero image containing a search bar to immediately engage users and communicate the purpose of the website.                                                                                                                 | ![screenshot](documentation/features/product-list.png)       |
| Property Search Bar             | Allows users to search properties that are available. The search bar requests queries for property name, bedrooms, guests, description and destinations.                                                                                                 | ![screenshot](documentation/features/product-details.png)    |
| Featured Properties             | Home page contains featured properties to encourage users to explore directly from the homepage.                                                                                                                                                         | ![screenshot](documentation/features/add-to-bag.png)         |
| Property Listings               | Displays a list of all available properties from the database which users can click on for more details.                                                                                                                                                 | ![screenshot](documentation/features/view-bag.png)           |
| Property Sort By                | Allows users to filter properties by low to high price, high to low, and newest properties.                                                                                                                                                              | ![screenshot](documentation/features/checkout.png)           |
| Property Details Display        | Displays full property information including description, price, max-guests, bedrooms, images and location. Having these on the page allows the user to understand what the property has to offer. This allows users to make informed booking decisions. | ![screenshot](documentation/features/order-confirmation.png) |
| Property Location Map           | Provides an interactive map showing the property's location. This helps users understand the surrounding area and what attractions and transport links are near by.                                                                                      | ![screenshot](documentation/features/profile-management.png) |
| Book Now Button                 | Allows users to begin the booking process directly from the property details page, allowing them to secure accommodation quickly and efficiently.                                                                                                        | ![screenshot](documentation/features/order-history.png)      |
| Property Review                 | Displays customer reviews that have previously stayed at the property, helping users assess the quality and reliability of a property and increase user trust in their booking decision.                                                                 | ![screenshot](documentation/features/product-management.png) |
| Amenities Display               | Shows a clear list of amenities for each property, allowing users to confirm that the property meets their specific requirements.                                                                                                                        | ![screenshot](documentation/features/newsletter.png)         |
| Destination Navigation Dropdown | Users can navigate destination locations on the navigation dropdown, allowing users to explore properties on chosen location.                                                                                                                            | ![screenshot](documentation/features/contact.png)            |
...
| User Feedback                   | Clear and concise Django messages are used to provide feedback to users when interacting with various features.                                                                                                                                          | ![screenshot](documentation/features/user-feedback.png)      |
| Pagination                      | Splits pages including properties page and admin pages to improve usability and performance.                                                                                                                                                             | ![screenshot](documentation/features/heroku.png)             |
| Booking Date                    | Allows users to pick a check-in and check-out date as well as number of guests staying. Dates that have been previously booked will be invalid and a error message will show. If dates are valid it will move onto the checkout page.                    | ![screenshot](documentation/features/heroku.png)             |
...
| Order Confirmation              | Users receive an on-screen and email confirmation with details of their purchase. users.                                                                                                                                                                 | ![screenshot](documentation/features/heroku.png)             |
| Admin Overview                  | Allows admin users to view a summary of total listings, total bookings, total users and total reviews. This provides admin to see platform activity, helping them monitor performance and to make informed decisions to manage and improve the system.   | ![screenshot](documentation/features/heroku.png)             |
...
| Admin CRUD - Listings           | Allows admin users to create, read, update, and delete property listings.This enables admin to manage available properties, ensuring the platform always displays accurate and up-to-date information about the properties for users.                    | ![screenshot](documentation/features/heroku.png)             |
| Admin CRUD - Users              | Allows admin users to manage user accounts, including updating and removing users. This ensures users have the right access control and helps maintain safe, organised user database.                                                                    | ![screenshot](documentation/features/seo.png)                |
| Admin CRUD - Bookings           | Allows admin users to view and manage user bookings, including editing and deleting bookings. This enables admins to support users with their bookings.                                                                                                  | ![screenshot](documentation/features/marketing.png)          |
| Admin CRUD - Reviews            | Allows admin users to manage user-submitted reviews, including editing or deleting them. This helps maintain content quality and ensures the reviews are appropriate and accurate.                                                                       | ![screenshot](documentation/features/404.png)                |
