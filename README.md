...
| Order History                   | Allows Logged-in users to see their recent orders details. This helps users keep track of past bookings and easily reference booking information when needed.                                                                                            | ![screenshot](docs/readme_imgs/order_history.png)               |
...
| Checkout                        | Users can proceed to checkout, where they provide their delivery details and payment information using Stripe integration.                                                                                                                               | ![screenshot](docs/readme_imgs/checkout.png)                    |
